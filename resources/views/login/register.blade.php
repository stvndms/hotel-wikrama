...
<body class="font-poppins bg-cover bg-fixed bg-center bg-no-repeat" style="background-image: url('assets/image/bgmin.jpg')">
    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="container 2xl:w-[550px] 2xl:h-[760px] lg:w-[450px] lg:h-[590px] md:w-[400px] md:h-[560px] w-[300px] h-[480px] bg-white/30 backdrop-blur-sm rounded-[10px] shadow-md 2xl:py-14 py-8 px-10 border-[1px] border-white">
            ...
            <h1 class="block text-center 2xl:mt-7 mt-4 text-grey 2xl:text-[15px] md:text-[13px] text-[10px]">Already have an account?<a class="text-dark" href=""><span class="underline underline-offset-1">Sign In </span></a></h1>
        </div>
    </div>
    <!-- Login Form End -->
</body>
