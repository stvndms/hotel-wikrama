    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="container 2xl:w-[500px] 2xl:h-[650px] lg:w-[450px] lg:h-[520px] md:w-[400px] md:h-[500px] w-[300px] h-[420px] bg-white/30 backdrop-blur-sm rounded-[10px] shadow-md 2xl:py-14 py-8 px-10 border-[1px] border-white">
            ...
            <form action="/login" method="POST"  autocomplete="off">
                ...
                <input type="email" name="email" id="email" placeholder="Enter your Email address" autofocus required class="form-control w-full 2xl:h-[50px] lg:h-[40px] md:h-[35px] h-[25px] text-[10px] md:text-sm bg-white/50 mb-5 px-5 backdrop-blur-sm border-[1px] border-white md:rounded-[10px] rounded-[5px]">
                <label for="password" class="block 2xl:mb-5 md:mb-3 mb-2 font-medium md:text-[15px] text-xs">Password</label>
                <div class="relative">
                    <input type="password" name="password" placeholder="Enter your Password" class="form-control w-full 2xl:h-[50px] lg:h-[40px] md:h-[35px] h-[25px] md:rounded-[10px] rounded-[5px] text-[10px] md:text-sm bg-white/50 px-5 backdrop-blur-sm border-[1px] border-white">
                ...
                <div class="mt-5 2xl:mt-7">
                    <button class="btn-primary w-full lg:h-[40px] 2xl:h-[50px] md:h-[35px] h-[30px] md:rounded-[10px] rounded-[7px] bg-orange text-white 2xl:text-base text-[10px] md:text-sm font-normal">Sign in</button>
                </div>
            </form>
